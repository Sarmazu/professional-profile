...
It exists to publish approved career materials in a format that is readable by both people and AI agents. The repository is not the source of truth. It is a public output layer generated or manually curated from private source materials.
...
The value of the repository is not in being a polished personal website. Its value is that it acts as a clean public interface over a deeper private career knowledge base.

It should make the candidate easier to analyze for roles such as technical program management, infrastructure and platform leadership, delivery management, engineering productivity, and adjacent AI-infrastructure / AgentOps roles.

It also creates a controlled boundary between private knowledge and public representation. This is important because career materials often contain sensitive details, informal wording, and early drafts that should not be copied directly into public channels.
...
- a raw case database;
- a full ATS system;
- a job-search automation product;
- a place for secrets or internal employer details;
- proof of all claims by itself;
- a production portfolio website unless explicitly developed later.

## Public wording principle

The repository should preserve the candidate's factual experience while making it safe and understandable for external readers.

When there is a conflict between vivid internal wording and safe public wording, choose safe public wording. When there is a conflict between a stronger claim and a precisely supported claim, choose the precisely supported claim.
